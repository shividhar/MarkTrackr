Meteor.methods({
	...
	deleteAssessmentType: function(classData){
		if(Meteor.isServer){
			...
			Classes.update({"_id": classData.classId, "authorId": Meteor.userId()}, {$pull: {"assessmentTypes": classData.newAssessmentType}});
		}
	},
	...
	changeAssessmentTypeCategory: function(classData){
		if(Meteor.isServer){
			...
			Classes.update({"_id": classData.classId, "authorId": Meteor.userId(), "assessmentTypes.typeName": classData.previousAssessmentTypeName}, {$set: {"assessmentTypes.$.categories": classData.newAssessmentTypeCategories}});
		}
	},
