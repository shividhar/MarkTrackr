Meteor.methods({
    createAssessment: function(assessmentData){
    	if(Meteor.isServer){
		    ...
		    if(!Classes.findOne({ "_id": assessmentData.parentClassId, "authorId": Meteor.userId()})){
		    	throw new Meteor.Error("Unauthorized Access");
		    }
			if(!Classes.findOne({"_id": assessmentData.parentClassId, "assessmentTypes.typeName": assessmentData.type})){
				throw new Meteor.Error("Unknown type name");
			}
